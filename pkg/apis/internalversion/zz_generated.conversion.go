...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*SelectorCondition)(nil), (*v1alpha1.SelectorCondition)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_internalversion_SelectorCondition_To_v1alpha1_SelectorCondition(a.(*SelectorCondition), b.(*v1alpha1.SelectorCondition), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.SelectorCondition)(nil), (*SelectorCondition)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_SelectorCondition_To_internalversion_SelectorCondition(a.(*v1alpha1.SelectorCondition), b.(*SelectorCondition), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_internalversion_SelectorCondition_To_v1alpha1_SelectorCondition(in *SelectorCondition, out *v1alpha1.SelectorCondition, s conversion.Scope) error {
	out.Expression = in.Expression
	return nil
}

// Convert_internalversion_SelectorCondition_To_v1alpha1_SelectorCondition is an autogenerated conversion function.
func Convert_internalversion_SelectorCondition_To_v1alpha1_SelectorCondition(in *SelectorCondition, out *v1alpha1.SelectorCondition, s conversion.Scope) error {
	return autoConvert_internalversion_SelectorCondition_To_v1alpha1_SelectorCondition(in, out, s)
}

func autoConvert_v1alpha1_SelectorCondition_To_internalversion_SelectorCondition(in *v1alpha1.SelectorCondition, out *SelectorCondition, s conversion.Scope) error {
	out.Expression = in.Expression
	return nil
}

// Convert_v1alpha1_SelectorCondition_To_internalversion_SelectorCondition is an autogenerated conversion function.
func Convert_v1alpha1_SelectorCondition_To_internalversion_SelectorCondition(in *v1alpha1.SelectorCondition, out *SelectorCondition, s conversion.Scope) error {
	return autoConvert_v1alpha1_SelectorCondition_To_internalversion_SelectorCondition(in, out, s)
}
...
func autoConvert_internalversion_StageSelector_To_v1alpha1_StageSelector(in *StageSelector, out *v1alpha1.StageSelector, s conversion.Scope) error {
	...
	out.MatchConditions = *(*[]v1alpha1.SelectorCondition)(unsafe.Pointer(&in.MatchConditions))
	return nil
}
...
func autoConvert_v1alpha1_StageSelector_To_internalversion_StageSelector(in *v1alpha1.StageSelector, out *StageSelector, s conversion.Scope) error {
	...
	out.MatchConditions = *(*[]SelectorCondition)(unsafe.Pointer(&in.MatchConditions))
	return nil
}
