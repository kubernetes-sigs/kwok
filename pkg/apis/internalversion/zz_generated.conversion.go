...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*MappingTarget)(nil), (*v1alpha1.MappingTarget)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_internalversion_MappingTarget_To_v1alpha1_MappingTarget(a.(*MappingTarget), b.(*v1alpha1.MappingTarget), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.MappingTarget)(nil), (*MappingTarget)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_MappingTarget_To_internalversion_MappingTarget(a.(*v1alpha1.MappingTarget), b.(*MappingTarget), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_internalversion_AttachConfig_To_v1alpha1_AttachConfig(in *AttachConfig, out *v1alpha1.AttachConfig, s conversion.Scope) error {
	...
	out.Mapping = (*v1alpha1.MappingTarget)(unsafe.Pointer(in.Mapping))
	return nil
}
...
func autoConvert_v1alpha1_AttachConfig_To_internalversion_AttachConfig(in *v1alpha1.AttachConfig, out *AttachConfig, s conversion.Scope) error {
	...
	out.Mapping = (*MappingTarget)(unsafe.Pointer(in.Mapping))
	return nil
}
...
func autoConvert_internalversion_MappingTarget_To_v1alpha1_MappingTarget(in *MappingTarget, out *v1alpha1.MappingTarget, s conversion.Scope) error {
	out.Name = in.Name
...
// Convert_internalversion_MappingTarget_To_v1alpha1_MappingTarget is an autogenerated conversion function.
func Convert_internalversion_MappingTarget_To_v1alpha1_MappingTarget(in *MappingTarget, out *v1alpha1.MappingTarget, s conversion.Scope) error {
	return autoConvert_internalversion_MappingTarget_To_v1alpha1_MappingTarget(in, out, s)
}

func autoConvert_v1alpha1_MappingTarget_To_internalversion_MappingTarget(in *v1alpha1.MappingTarget, out *MappingTarget, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	out.Container = in.Container
	return nil
...
// Convert_v1alpha1_MappingTarget_To_internalversion_MappingTarget is an autogenerated conversion function.
func Convert_v1alpha1_MappingTarget_To_internalversion_MappingTarget(in *v1alpha1.MappingTarget, out *MappingTarget, s conversion.Scope) error {
	return autoConvert_v1alpha1_MappingTarget_To_internalversion_MappingTarget(in, out, s)
}
