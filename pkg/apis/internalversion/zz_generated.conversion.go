...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*v1alpha1.ExpressionFromSource)(nil), (*ExpressionFromSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddConversionFunc((*v1alpha1.SelectorExpression)(nil), (*SelectorExpression)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_internalversion_StageDelay_To_v1alpha1_StageDelay(in *StageDelay, out *v1alpha1.StageDelay, s conversion.Scope) error {
	...
	if in.DurationFrom != nil {
		...
		*out = new(v1alpha1.ExpressionFromSource)
		if err := Convert_internalversion_ExpressionFromSource_To_v1alpha1_ExpressionFromSource(*in, *out, s); err != nil {
			return err
		}
	} else {
...
func autoConvert_v1alpha1_StageDelay_To_internalversion_StageDelay(in *v1alpha1.StageDelay, out *StageDelay, s conversion.Scope) error {
	...
	if in.DurationFrom != nil {
		...
		*out = new(ExpressionFromSource)
		if err := Convert_v1alpha1_ExpressionFromSource_To_internalversion_ExpressionFromSource(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.DurationFrom = nil
...
func autoConvert_internalversion_StageSelector_To_v1alpha1_StageSelector(in *StageSelector, out *v1alpha1.StageSelector, s conversion.Scope) error {
	...
	if in.MatchExpressions != nil {
		...
		*out = make([]v1alpha1.SelectorExpression, len(*in))
		for i := range *in {
			if err := Convert_internalversion_SelectorExpression_To_v1alpha1_SelectorExpression(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha1_StageSelector_To_internalversion_StageSelector(in *v1alpha1.StageSelector, out *StageSelector, s conversion.Scope) error {
	...
	if in.MatchExpressions != nil {
		...
		*out = make([]SelectorExpression, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_SelectorExpression_To_internalversion_SelectorExpression(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
