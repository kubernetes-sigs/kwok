...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HTTPRoute)(nil), (*v1alpha1.HTTPRoute)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_internalversion_HTTPRoute_To_v1alpha1_HTTPRoute(a.(*HTTPRoute), b.(*v1alpha1.HTTPRoute), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.HTTPRoute)(nil), (*HTTPRoute)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_HTTPRoute_To_internalversion_HTTPRoute(a.(*v1alpha1.HTTPRoute), b.(*HTTPRoute), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*HTTPRouteHeader)(nil), (*v1alpha1.HTTPRouteHeader)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_internalversion_HTTPRouteHeader_To_v1alpha1_HTTPRouteHeader(a.(*HTTPRouteHeader), b.(*v1alpha1.HTTPRouteHeader), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.HTTPRouteHeader)(nil), (*HTTPRouteHeader)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_HTTPRouteHeader_To_internalversion_HTTPRouteHeader(a.(*v1alpha1.HTTPRouteHeader), b.(*HTTPRouteHeader), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_internalversion_Forward_To_v1alpha1_Forward(in *Forward, out *v1alpha1.Forward, s conversion.Scope) error {
	...
	out.Command = *(*[]string)(unsafe.Pointer(&in.Command))
	out.HTTPRoutes = *(*[]v1alpha1.HTTPRoute)(unsafe.Pointer(&in.HTTPRoutes))
	return nil
}
...
func autoConvert_v1alpha1_Forward_To_internalversion_Forward(in *v1alpha1.Forward, out *Forward, s conversion.Scope) error {
	...
	out.Command = *(*[]string)(unsafe.Pointer(&in.Command))
	out.HTTPRoutes = *(*[]HTTPRoute)(unsafe.Pointer(&in.HTTPRoutes))
	return nil
}
...
func autoConvert_internalversion_HTTPRoute_To_v1alpha1_HTTPRoute(in *HTTPRoute, out *v1alpha1.HTTPRoute, s conversion.Scope) error {
	out.Location = in.Location
	out.Code = in.Code
	out.Headers = *(*[]v1alpha1.HTTPRouteHeader)(unsafe.Pointer(&in.Headers))
	out.Body = in.Body
	return nil
}

// Convert_internalversion_HTTPRoute_To_v1alpha1_HTTPRoute is an autogenerated conversion function.
func Convert_internalversion_HTTPRoute_To_v1alpha1_HTTPRoute(in *HTTPRoute, out *v1alpha1.HTTPRoute, s conversion.Scope) error {
	return autoConvert_internalversion_HTTPRoute_To_v1alpha1_HTTPRoute(in, out, s)
}

func autoConvert_v1alpha1_HTTPRoute_To_internalversion_HTTPRoute(in *v1alpha1.HTTPRoute, out *HTTPRoute, s conversion.Scope) error {
	out.Location = in.Location
	out.Code = in.Code
	out.Headers = *(*[]HTTPRouteHeader)(unsafe.Pointer(&in.Headers))
	out.Body = in.Body
	return nil
}

// Convert_v1alpha1_HTTPRoute_To_internalversion_HTTPRoute is an autogenerated conversion function.
func Convert_v1alpha1_HTTPRoute_To_internalversion_HTTPRoute(in *v1alpha1.HTTPRoute, out *HTTPRoute, s conversion.Scope) error {
	return autoConvert_v1alpha1_HTTPRoute_To_internalversion_HTTPRoute(in, out, s)
}

func autoConvert_internalversion_HTTPRouteHeader_To_v1alpha1_HTTPRouteHeader(in *HTTPRouteHeader, out *v1alpha1.HTTPRouteHeader, s conversion.Scope) error {
	out.Name = in.Name
	out.Value = in.Value
	return nil
}

// Convert_internalversion_HTTPRouteHeader_To_v1alpha1_HTTPRouteHeader is an autogenerated conversion function.
func Convert_internalversion_HTTPRouteHeader_To_v1alpha1_HTTPRouteHeader(in *HTTPRouteHeader, out *v1alpha1.HTTPRouteHeader, s conversion.Scope) error {
	return autoConvert_internalversion_HTTPRouteHeader_To_v1alpha1_HTTPRouteHeader(in, out, s)
}

func autoConvert_v1alpha1_HTTPRouteHeader_To_internalversion_HTTPRouteHeader(in *v1alpha1.HTTPRouteHeader, out *HTTPRouteHeader, s conversion.Scope) error {
	out.Name = in.Name
	out.Value = in.Value
	return nil
}

// Convert_v1alpha1_HTTPRouteHeader_To_internalversion_HTTPRouteHeader is an autogenerated conversion function.
func Convert_v1alpha1_HTTPRouteHeader_To_internalversion_HTTPRouteHeader(in *v1alpha1.HTTPRouteHeader, out *HTTPRouteHeader, s conversion.Scope) error {
	return autoConvert_v1alpha1_HTTPRouteHeader_To_internalversion_HTTPRouteHeader(in, out, s)
}
