...
func (c *FakeControllers) UpdateStatus(ctx context.Context, controller *v1alpha1.Controller, opts v1.UpdateOptions) (*v1alpha1.Controller, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(controllersResource, "status", c.ns, controller), &v1alpha1.Controller{})
...
func (c *FakeControllers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(controllersResource, c.ns, listOpts)
...
func (c *FakeControllers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Controller, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(controllersResource, c.ns, name, pt, data, subresources...), &v1alpha1.Controller{})
