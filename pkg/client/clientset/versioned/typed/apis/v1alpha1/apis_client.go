...
// NewForConfig creates a new KwokV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new KwokV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*KwokV1alpha1Client, error) {
	...
	return &KwokV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new KwokV1alpha1Client for the given config and
...
func New(c rest.Interface) *KwokV1alpha1Client {
	return &KwokV1alpha1Client{c}
}
