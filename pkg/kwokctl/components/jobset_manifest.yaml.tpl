            ...
            properties:
              ...
              network:
                ...
                - message: Value is immutable
                  rule: self == oldSelf
              replicatedJobs:
                description: replicatedJobs is the group of jobs that will form the
                  set.
                items:
                  properties:
                    dependsOn:
                          ...
                          properties:
                            ...
                            podFailurePolicy:
                              description: |-
                                ...
                                If empty, the default behavior applies - the counter of failed pods,
                                  ...
                                  items:
                                    ...
                                    properties:
                                      action:
                                        ...
                                        type: string
                                      onExitCodes:
                                        description: Represents the requirement on
                                                ...
                                                properties:
                                                  ...
                                                  httpGet:
                                                    description: HTTPGet specifies
                                                      an HTTP GET request to perform.
                                                    properties:
                                                      host:
                                                        description: |-
                                          ...
                                          livenessProbe:
                                            ...
                                            properties:
                                              ...
                                              grpc:
                                                ...
                                                type: object
                                              httpGet:
                                                description: HTTPGet specifies an
                                            ...
                                            items:
                                              ...
                                              properties:
                                                action:
                                                  ...
                                                  type: string
                                                exitCodes:
                                                  description: Represents the exit
                                                    codes to check on container exits.
                                                  properties:
                                                    operator:
                                                      description: |-
                                                        Represents the relationship between the container exit code(s) and the
                                      ...
                                      properties:
                                        ...
                                        seLinuxChangePolicy:
                                          description: |-
                                            ...
                                            Eligible volumes are in-tree FiberChannel and iSCSI volumes, and all CSI volumes
                                            whose CSI driver announces SELinux support by setting spec.seLinuxMount: true in their
                                            CSIDriver instance. Other volumes are always re-labeled recursively.
                                      ...
                                      items:
                                        ...
                                        properties:
                                          ...
                                          ephemeral:
                                            ...
                                            type: object
                                          fc:
                                            description: fc represents a Fiber Channel
                                            ...
                                            properties:
                                              ...
                                              volumeNamespace:
                                                description: |-
                                                  ...
                                                  Set VolumeName to any name to override the default behavior.
              ...
              successPolicy:
                ...
                properties:
                  operator:
                    description: operator determines either All or Any of the selected
                      jobs should succeed to consider the JobSet successful
                    enum:
                    - All
                    - Any
                    type: string
              ...
              volumeClaimPolicies:
                ...
                items:
                  description: volumeClaimPolicy defines volume claim templates and
                    lifecycle management for shared PVCs.
                  properties:
                    retentionPolicy:
                      description: |-
                  ...
                  - message: namespace cannot be set for VolumeClaimPolicies templates
                    rule: self.templates.all(t, !has(t.metadata.namespace) || size(t.metadata.namespace)
                      == 0)
                maxItems: 50
                type: array
                x-kubernetes-list-type: atomic
          ...
          status:
            ...
            properties:
              ...
              replicatedJobsStatus:
                description: replicatedJobsStatus tracks the number of JobsReady for
                  each replicatedJob.
                items:
              ...
              restartsCountTowardsMax:
                description: restartsCountTowardsMax tracks the number of times the
                  JobSet has restarted that counts towards the maximum allowed number
                  of restarts.
                format: int32
                type: integer
              terminalState:
