...
`)
	...
	cmd.Flags().StringSliceVar(&flags.Options.KubeApiserverCORSAllowedOriginList, "kube-apiserver-cors-allowed-origin", flags.Options.KubeApiserverCORSAllowedOriginList, "List of origins that are allowed to perform CORS requests")
