...
```
      ...
      --dashboard-image string                  Image of dashboard, only for docker/podman/nerdctl runtime
      ...
      --etcd-binary string                      Binary of etcd, only for binary runtime (default "https://github.com/etcd-io/etcd/releases/download/v3.5.21/etcd-v3.5.21-linux-amd64.tar.gz#etcd")
      --etcd-image string                       Image of etcd, only for docker/podman/nerdctl runtime
                                                '${KWOK_KUBE_IMAGE_PREFIX}/etcd:${KWOK_ETCD_VERSION}'
                                                 (default "registry.k8s.io/etcd:3.5.21-0")
      --etcd-port uint32                        Port of etcd given to the host
  ...
  -h, --help                                    help for cluster
      ...
      --jaeger-image string                     Image of Jaeger, only for docker/podman/nerdctl runtime
      ...
      --kube-admission                          Enable admission for kube-apiserver (default true)
      --kube-apiserver-binary string            Binary of kube-apiserver, only for binary runtime
                                                 (default "https://dl.k8s.io/release/v1.33.0/bin/linux/amd64/kube-apiserver")
      --kube-apiserver-image string             Image of kube-apiserver, only for docker/podman/nerdctl runtime
                                                '${KWOK_KUBE_IMAGE_PREFIX}/kube-apiserver:${KWOK_KUBE_VERSION}'
                                                 (default "registry.k8s.io/kube-apiserver:v1.33.0")
      ...
      --kube-authorization                      Enable authorization for kube-apiserver (default true)
      --kube-controller-manager-binary string   Binary of kube-controller-manager, only for binary runtime
                                                 (default "https://dl.k8s.io/release/v1.33.0/bin/linux/amd64/kube-controller-manager")
      --kube-controller-manager-image string    Image of kube-controller-manager, only for docker/podman/nerdctl runtime
                                                '${KWOK_KUBE_IMAGE_PREFIX}/kube-controller-manager:${KWOK_KUBE_VERSION}'
                                                 (default "registry.k8s.io/kube-controller-manager:v1.33.0")
      ...
      --kube-scheduler-binary string            Binary of kube-scheduler, only for binary runtime
                                                 (default "https://dl.k8s.io/release/v1.33.0/bin/linux/amd64/kube-scheduler")
      ...
      --kwok-controller-image string            Image of kwok-controller, only for docker/podman/nerdctl runtime
      ...
      --metrics-server-image string             Image of metrics-server, only for docker/podman/nerdctl runtime
      ...
      --prometheus-image string                 Image of Prometheus, only for docker/podman/nerdctl runtime
